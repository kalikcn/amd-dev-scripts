...
if [[ "$install_choice" =~ ^[Yy]$ ]]; then
    SOFTWARE_LIST="psmisc nc net-tools rsync vim lrzsz ntp libzstd1 openssl tree iotop git curl wget htop unzip zip tar build-essential pciutils timeshift obs-studio"
